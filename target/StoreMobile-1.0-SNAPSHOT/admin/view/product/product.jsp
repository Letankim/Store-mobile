                                                ...
                                                <div class="modal-body">
                                                    <form accept-charset="UTF-8" method="post" action="/admin/product" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="price" onchange="document.querySelector('.price-sale').max = this.value" pattern="[0-9]+([.,][0-9]+)?" min="0" required type="text" name="price" class="form-control">
                                                            <span class="message_error"></span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Product price sale</label>
                                                            <input id="price-sale" pattern="[0-9]+([.,][0-9]+)?" min="0" value="0" required type="text" name="priceSale" class="form-control price-sale">
                                                            <span class="message_error"></span>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Available</label>
                                                            <input id="available" required type="number" name="numberOfProduct" class="form-control">
                                                            <span class="message_error"></span>
                                                        </div>
                                                        <div class="form-group">
