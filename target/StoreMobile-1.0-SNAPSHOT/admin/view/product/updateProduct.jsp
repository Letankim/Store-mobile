                ...
                <div class="box-content">
                    <form class="cmxform form-horizontal form-validate" accept-charset="UTF-8" method="post" action="/admin/product" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <input id="price" onchange="document.querySelector('.price-sale').max = this.value" pattern="[0-9]+([.,][0-9]+)?" value="${currency.currencyFormatInput(product.oldPrice)}" min="0" name="price" type="text" class="form-control" required>
                                <span class="message_error"></span>
                            </div>
                        </div>
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <input id="price-sale" pattern="[0-9]+([.,][0-9]+)?" value="${currency.currencyFormatInput(product.newPrice)}" min="0" max="${product.oldPrice}" name="priceSale" type="text" class="form-control price-sale" required>
                                <span class="message_error"></span>
                            </div>
                        </div>
                        <div class="form-group col-lg-6">
                            <label class="control-label col-lg-12">Available</label>
                            <div class="col-lg-12">
                                <input id="available" value="${product.available}" name = "available" class=" form-control" required>
