<%-- 
    Document   : signUp
    Created on : Oct 30, 2023, 1:16:59 PM
    Author     : Le Tan Kim
--%>
                ...
                <section class="form-inf">
                    ...
                    <ul class="nav nav-pills nav-justified mb-3">
                        <li class="nav-item-auth" role="presentation">
                            <a href="/auth/login" class="nav-link-auth" id="tab-login">Login</a>
                        </li> 
                        <li class="nav-item-auth" role="presentation">
                            <a class="nav-link-auth active text-uppercase" id="tab-login">Register</a>
                        </li> 
                    </ul>
                    <!-- Pills content -->
                    <div class="container-subnav" id="register-active-show">
                        <form action="/auth/register" class="form__login" method="post" id='form-register'>
                            ...
                            <button id="register-btn" class="form-submit btn btn-primary btn-submit-form" name="register" type="submit">Register</button>
                        </form>
                    </div>
                </section>
            </section>
